...
package robotlegs.bender.extensions.mediatorMap.impl
{
	...
	public class StarlingMediatorFactory
	{
		...
		{
			_injector = injector;
			_manager = manager || new StarlingMediatorManager(this);
		}
		 ...
		 * @private
		 */
		public function getMediator(item:Object, mapping:StarlingMediatorMapping):Object
		{
		...
		public function createMediators(item:Object, type:Class, mappings:Array):Array
		{
			...
			var mediator:Object;
			for each (var mapping:StarlingMediatorMapping in mappings)
			{
		...
		public function removeMediators(item:Object):void
		{
			...
			{
				_manager.removeMediator(mediators[mapping], item, mapping as StarlingMediatorMapping);
			}
		...
		private function createMediator(item:Object, mapping:StarlingMediatorMapping):Object
		{
		...
		private function addMediator(mediator:Object, item:Object, mapping:StarlingMediatorMapping):void
		{
